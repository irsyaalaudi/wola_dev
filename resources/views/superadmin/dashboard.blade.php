                    ...
                    <table class="table-auto text-sm text-gray-700 border-separate border-spacing-0 min-w-max relative">
                        <thead class="text-gray-700 text-center">
                            <tr>
                                ...
                                <th rowspan="2" class="px-3 py-2 border sticky top-0 bg-blue-100 z-10">Grade</th>
                                @foreach ($teams as $team)
                                    <th colspan="2" class="px-3 py-2 border sticky top-0 bg-blue-400 text-white z-10">
                            ...
                            <tr>
                                @foreach ($teams as $team)
                                    <th class="px-2 py-1 border sticky top-[40px] bg-blue-300 text-white z-10">T</th>
                                    <th class="px-2 py-1 border sticky top-[40px] bg-blue-300 text-white z-10">R</th>
                                @endforeach
                            </tr>
                        </thead>
                        <tbody>
                            @forelse ($data as $index => $item)
                                <tr class="hover:bg-gray-50">
                                    <td class="px-3 py-2 border-r border-gray-200 text-center sticky left-0 bg-white z-20">
                                        {{ $index + 1 }}</td>
                                    <td class="px-3 py-2 border-r border-gray-200 text-left sticky left-12 bg-white z-20">
                            ...
                            @empty
                                <tr>
                                    <td colspan="{{ 5 + $teams->count() * 2 }}"
                                        class="px-3 py-4 border text-center text-gray-500">
                                        Tidak ada data.
                                    </td>
                                </tr>
                            @endforelse
        ...
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                        ...
                        backgroundColor: 'rgba(70, 145, 255, 1)'
                    },
                    {
